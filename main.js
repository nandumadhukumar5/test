(function($) {
    ...
    if ($('.tvm-newlaunch').length > 0) {
        $('.tvm-newlaunch').owlCarousel({
            'nav': true,
            'dots': false,
            'margin': 30,
            'loop' : true,
            ...
            'navText': [`<svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" viewBox="0 0 32.414 20.828">
                            <g id="Group_30" data-name="Group 30" transform="translate(-1845.086 -1586.086)">
                                <line id="Line_2" data-name="Line 2" x1="30" transform="translate(1846.5 1596.5)" fill="none" stroke="#333" stroke-linecap="round" stroke-width="2"/>
                                <line id="Line_3" data-name="Line 3" x1="9" y2="9" transform="translate(1846.5 1587.5)" fill="none" stroke="#333" stroke-linecap="round" stroke-width="2"/>
                                <line id="Line_4" data-name="Line 4" x1="9" y1="9" transform="translate(1846.5 1596.5)" fill="none" stroke="#333" stroke-linecap="round" stroke-width="2"/>
                        ...
                        `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" viewBox="0 0 32.414 20.828">
                            <g id="Symbol_1_1" data-name="Symbol 1 – 1" transform="translate(-1847.5 -1589.086)">
                                <line id="Line_2" data-name="Line 2" x2="30" transform="translate(1848.5 1599.5)" fill="none" stroke="#333" stroke-linecap="round" stroke-width="2"/>
                                <line id="Line_3" data-name="Line 3" x2="9" y2="9" transform="translate(1869.5 1590.5)" fill="none" stroke="#333" stroke-linecap="round" stroke-width="2"/>
                                <line id="Line_4" data-name="Line 4" y1="9" x2="9" transform="translate(1869.5 1599.5)" fill="none" stroke="#333" stroke-linecap="round" stroke-width="2"/>
    ...
    if ($('.tvm-ongoing').length > 0) {
        $('.tvm-ongoing').owlCarousel({
            'nav': true,
            'dots': false,
            'margin': 30,
            'loop' : true,
    ...
    if ($('.tvm-ready').length > 0) {
        $('.tvm-ready').owlCarousel({
            'nav': true,
            'dots': false,
            'margin': 30,
            'loop' : true,
    ...
    if ($('.cochin-new').length > 0) {
        $('.cochin-new').owlCarousel({
            'nav': true,
            'dots': false,
            'margin': 30,
            'loop' : true,
    ...
    if ($('.cochin-ongoing').length > 0) {
        $('.cochin-ongoing').owlCarousel({
            'nav': true,
            'dots': false,
            'margin': 30,
            'loop' : true,
    ...
    if ($('.cochin-kottayam-ready').length > 0) {
        $('.cochin-kottayam-ready').owlCarousel({
            'nav': true,
            'dots': false,
            'margin': 30,
            'loop' : true,
    ...
    $('.pxp-nav > li').hover(function() {
        ...
        if (subMenu.length > 0 && !$('.pxp-header').hasClass('pxp-mobile')) {
            ...
            subMenu.fadeIn({ queue: false, duration: 300 });
            subMenu.animate({ top: "100px" }, 300);
        }
    }, function() {
        var subMenu = $(this).children('ul:first');

        if (subMenu.length > 0  && !$('.pxp-header').hasClass('pxp-mobile')) {
            subMenu.fadeOut({ queue: false, duration: 300 });
            subMenu.animate({ top: "120px" }, 300);
        }
    });
